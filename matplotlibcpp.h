...
inline void SetChartTitle(PyObject * ax, std::string title_msg)
{
    PyObject * titleF = PyObject_GetAttrString(ax, "set_title");
    PyObject * args = PyTuple_New(1);
    PyTuple_SetItem(args, 0, PyUnicode_FromString(title_msg.c_str()));
    PyObject_CallObject(titleF, args);
}
